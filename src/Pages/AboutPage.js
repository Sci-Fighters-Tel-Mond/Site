...
function AboutPage() {
	return (
		<div id="aboutpage">
			...
			<div id="about-text">
				<div className="center-text" id="about-header">Who Are We?</div>
				...
				<br /><div className="center-text" id="about-accomplishments">Accomplishments <i className="fa-solid fa-award"></i></div>
