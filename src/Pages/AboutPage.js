	...
	return (
		<div id="aboutpage">
			...
			<div id="about-text">
				...
				On our first season, we reached with <a href="https://linktr.ee/FataMorgana15637"><span style={{ color: "rgb(94, 65, 147)" }}>Fata Morgana #15637</span></a> from Ramat Hanegev to the highest score in Europe && Asia.<br/>
				...
				<br />In addition, we've won the promote award, that is given to the team that has made the best video that promotes FIRST, this year, the video was on the topic of "How to do robotics in covid".  <a href="https://www.youtube.com/watch?v=s4N94JtRMsI" className="button">Promote video 2021</a><br />As well, in the 2022-2023 Powerplay season, one of our team's members accomplished the Dean's List award - An award given to students in effort to recognize the leadership and dedication of FIRST's most outstanding secondary school students.<br /><br />
